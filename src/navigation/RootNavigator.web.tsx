...
function injectDesktopDocumentStyles() {
  ...
  style.textContent = `
    html,body,#root{width:100%;height:100%;margin:0;overflow:hidden;background:#000000}
    *{box-sizing:border-box} body{font-family:Inter,"Segoe UI Variable Text","Segoe UI",sans-serif;-webkit-font-smoothing:antialiased}
    ...
    .slider-container:hover .slider-fill{background:#9B7BFF!important}
  `;
...
const styles = StyleSheet.create({
  root: { flex: 1, backgroundColor: '#000000', color: desktop.text } as any,
  titleBar: { height: 38, backgroundColor: '#000000', flexDirection: 'row', alignItems: 'stretch', zIndex: 20, WebkitAppRegion: 'drag' } as any,
  ...
  main: { flex: 1, flexDirection: 'row', minHeight: 0, backgroundColor: '#000000' }, sidebar: { width: 224, backgroundColor: '#121218', borderRadius: 8, marginLeft: 8, marginRight: 4, marginTop: 4, marginBottom: 8, overflow: 'hidden' } as any, sidebarContent: { padding: 12, paddingTop: 22 }, navLabel: { color: desktop.dim, fontSize: 9, fontWeight: '800', letterSpacing: 1.35, marginHorizontal: 10, marginBottom: 8, marginTop: 5 }, navItem: { height: 38, paddingHorizontal: 10, borderRadius: 7, flexDirection: 'row', alignItems: 'center', gap: 11, marginBottom: 3 }, navHover: { backgroundColor: desktop.hover }, navActive: { backgroundColor: desktop.accentSoft }, navText: { color: desktop.muted, fontSize: 13, fontWeight: '550' as any, flex: 1 }, navTextActive: { color: desktop.text, fontWeight: '650' as any }, shortcut: { color: desktop.dim, fontSize: 9 }, navDivider: { height: 1, backgroundColor: desktop.border, marginVertical: 14, marginHorizontal: 8 },
  account: { minHeight: 67, paddingHorizontal: 14, borderTopWidth: 1, borderTopColor: 'rgba(255,255,255,0.03)', flexDirection: 'row', alignItems: 'center', gap: 10 }, avatar: { width: 31, height: 31, borderRadius: 9, backgroundColor: '#3D315E', alignItems: 'center', justifyContent: 'center' }, avatarText: { color: desktop.text, fontSize: 12, fontWeight: '800' }, accountName: { color: desktop.text, fontSize: 12, fontWeight: '650' as any }, accountEmail: { color: desktop.dim, fontSize: 10, marginTop: 2 }, content: { flex: 1, minWidth: 0, backgroundColor: '#121218', borderRadius: 8, marginLeft: 4, marginRight: 8, marginTop: 4, marginBottom: 8, overflow: 'hidden' } as any,
