...
const styles = StyleSheet.create({
  ...
  main: { flex: 1, flexDirection: 'row', minHeight: 0, backgroundColor: 'transparent' }, sidebar: { width: 232, borderRadius: RAIO.superficie, borderWidth: 1, borderColor: COR.linhaSuave, marginLeft: ESP.sm, marginRight: ESP.xs, marginTop: ESP.xs, marginBottom: ESP.xs, overflow: 'hidden' } as any, sidebarContent: { padding: ESP.md, paddingTop: ESP.xl }, navLabel: { ...TIPO.micro, color: COR.textoFraco, marginHorizontal: ESP.md, marginBottom: ESP.sm, marginTop: ESP.md }, navItem: { height: 40, paddingHorizontal: ESP.md, borderRadius: RAIO.cartao, flexDirection: 'row', alignItems: 'center', gap: ESP.md, marginBottom: 2 }, navHover: { backgroundColor: desktop.hover }, navActive: { backgroundColor: desktop.accentSoft }, navText: { ...TIPO.corpo, color: COR.textoMedio, fontWeight: '500' as any, flex: 1 }, navTextActive: { color: desktop.text, fontWeight: '650' as any }, shortcut: { fontFamily: FONT.mono, color: desktop.dim, fontSize: 9 }, navDivider: { height: 1, backgroundColor: desktop.border, marginVertical: 14, marginHorizontal: 8 },
